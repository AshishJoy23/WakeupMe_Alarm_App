            ...
            children: [
              Image.asset(
                ...
                errorBuilder: (context, error, stackTrace) {
                  return Center(
                    child: InkWell(
                      onTap: () async {
                        await globalController.getCurrentLocation();
                        getAddress(globalController.getLatitude().value,
                            globalController.getLongitude().value);
                      },
                      child: const Icon(
              ...
              RichText(
                text: TextSpan(children: [
                  TextSpan(
                    text:
                        "${globalController.weatherData.value.current!.temp!.toInt()}°",
                    style: TextStyle(
                  ...
                  TextSpan(
                    text:
                        "${globalController.weatherData.value.current!.weather![0].description}",
                    style: TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 14,
                      color: CustomColors.secondaryTextColor.withAlpha(220),
